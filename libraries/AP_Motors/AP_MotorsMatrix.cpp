        ...
        case MOTOR_FRAME_OCTA:
            switch (frame_type) {
               ...
               case MOTOR_FRAME_TYPE_HH:
                    add_motor_raw(AP_MOTORS_MOT_1, -0.388f,  0.893f, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 1);
                    add_motor_raw(AP_MOTORS_MOT_2,  0.388f, -0.893f, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 2);
                    add_motor_raw(AP_MOTORS_MOT_3,  0.388f,  0.893f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  3);
                    add_motor_raw(AP_MOTORS_MOT_4, -0.388f, -0.893f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  4);
                    add_motor_raw(AP_MOTORS_MOT_5, -1.0f,    0.647f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 5); 
                    add_motor_raw(AP_MOTORS_MOT_6,  1.0f,   -0.647f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 6);
                    add_motor_raw(AP_MOTORS_MOT_7,  1.0f,    0.647f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  7);
                    add_motor_raw(AP_MOTORS_MOT_8, -1.0f,   -0.647f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  8);
                    success = true;
                    break;
                default:
